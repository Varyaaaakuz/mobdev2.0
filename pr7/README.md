...
Все существующие фрагменты приложения были переделаны для использования View Binding. Для каждого фрагмента создан соответствующий класс Binding. Это не только упростило код, но и повысило его безопасность - ошибки обращения к несуществующим элементам теперь обнаруживаются на этапе компиляции, а не во время выполнения.
